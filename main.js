document.addEventListener('DOMContentLoaded', () => {
  ...
  const dataMaps = {
    ...
    lectureType: { 'general': '교양 강의', 'major': '전공 필수 강의', 'seminar': '세미나/발표 수업' },
    tone: { 'academic': '학술적 스타일', 'explanatory': '설명적 스타일', 'critical': '비평적 스타일', 'persuasive': '설득적 스타일', 'creative': '창의적 스타일' },
    assignmentType: { 'report': '리포트', 'ppt': 'PPT 개요', 'summary': '논문 요약/분석', 'problem-solving': '연습문제 풀이', 'brainstorming': '아이디어 브레인스토밍', 'proofreading': '글 교정/개선', 'lab-report': '실험 보고서', 'cover-letter': '취업 자기소개서' },
    emphasis: { 
